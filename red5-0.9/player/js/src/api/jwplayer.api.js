...
(function(jwplayer) {
	...
	jwplayer.api = function(container) {
		...
		this.setHotspots = function(hotspots) {
			this.callInternal("jwSetHotspots", hotspots);
			return this;
		};
		...
		// State events
		this.onHotspotAdded = function(callback) {
			return this.eventListener(jwplayer.api.events.JWPLAYER_HOTSPOTADDED, callback);
		};

		this.onNoteAdded = function(callback) {
			return this.eventListener(jwplayer.api.events.JWPLAYER_NOTEADDED, callback);
		};
	
		this.onQuestionAdded = function(callback) {
			return this.eventListener(jwplayer.api.events.JWPLAYER_QUESTIONADDED, callback);
		};
