...
function ff_get_content_key() {
	...
	// var testVar = '{"Uploaded":"true",
	// "ContentPath":"/var/www/html/zikload-xml/uploads/document/f1371192015",
	// "ThumbnailPicturePath":"/var/www/html/zikload-xml/uploads/document/f1371192015/thumbnails/",
	// "NumberOfThumbnails":"1", "ContentType":"pdf",
	// "ContentKey":"f1371192015","Decoration":"Annotated"}';
	// console.log(contentId + " originalContentPath ---------->>>>> " +
	// originalContentPath);
...
function ff_set_response(annotationResponse) {
	...
	// TODO delete later for testing only
	// annotationResponse = '{"Uploaded":"true",
	// "ContentPath":"/var/www/html/zikload-xml/uploads/document/f1371192015",
	// "ThumbnailPicturePath":"/var/www/html/zikload-xml/uploads/document/f1371192015/thumbnails/",
	// "NumberOfThumbnails":"1", "ContentType":"pdf",
	// "ContentKey":"f1371192015","Decoration":"Annotated"}';
	...
	if (jsonObject.ContentKey != originalContentPath) {
		// console.log("Creating a new content old key was " +
		// originalContentPath + " and the new key is " +
		// jsonObject.ContentKey);
	...
	// TODO delete later
		...
		// console.log("Doing nothing old key was " + originalContentPath + "
		// and the new key is " + jsonObject.ContentKey);
	}
...
function createContent() {
	...
	// console.log("came here jsonObject.NumberOfThumbnails " +
	// jsonObject.NumberOfThumbnails);
	// console.log("the values are " + jsonObject.ThumbnailPicturePath + " " +
	// jsonObject.Decoration + " " + jsonObject.ContentKey);
	var parameters = {
