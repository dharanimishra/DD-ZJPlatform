...
*/
         ...
         for (var i = start; i < end; i++) {
           ...
           /* if (options.use24Hour) {
			...
			if (options.use24Hour2) {
			
               calendarBodyHtml += "<div class=\"wc-time-header-cell\" style='font-size:14px;'>" + self._weeks(i) + "</div>";
           
			}
			else {
               calendarBodyHtml += "<div class=\"wc-time-header-cell\">" + self._weeks(i) +  + "</div>";
            }
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         date: new Date(),
         timeFormat : "h:i a",
         dateFormat : "", //format edited by sundip shah
         use24Hour : false,
		 use24Hour2 :["Week-1","Week-2","Week-3", "week-4", "week-5", "week-6", "week-7"],
         daysToShow : 7,
