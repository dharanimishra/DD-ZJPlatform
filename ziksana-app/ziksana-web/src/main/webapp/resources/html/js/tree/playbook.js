// JavaScript Document by Sundip editable
 ...
 $(document).ready(function () {
            ...
            $('#jqxTree').jqxTree({ allowDrag: true, allowDrop: true,  width: '450px', theme: theme ,
					dragStart: function (item) {
                    if (item.label == "Playbook")
                        return false;
					}
			 });
			 $('#_test').jqxTree({ allowDrag: true, allowDrop: true,  width: '200px', theme: theme ,
			 		dragStart: function (item) {
                    if (item.label == "Playbook")
                        return false;
					}
			  ...
			  $("#jqxTree, #_test").bind('dragStart', function (event) {
                $("#dragStartLog").text("Drag Start: " + event.args.label);
                $("#dragEndLog").text("");
            });
			
			
			 $("#_test, #jqxTree").bind('dragStart', function (event) {
                $("#dragStartLog").text("Drag Start: " + event.args.label);
                $("#dragEndLog").text("");
            });
			//spliiter
			$("#splitter").jqxSplitter({ theme: theme, width: 920, panels: [{ size: 200}] });
