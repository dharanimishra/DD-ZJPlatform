	...
	$(document).ready(function(e) {
		...
		$('#aCom').click( function(e){
			e.preventDefault();
			$("#reviewtable tbody").append("<tr><td><input type='text' placeholder='Reviewer..' style='width:60px;'/></td><td><input type='text' placeholder='Component name..' style='width:80px;'/></td><td><input type='text' placeholder='Your comment..' style='width:80px;'/></td><td><input type='text' style='width:60px;' placeholder='Security..' /></td><td><input type='text' placeholder='Status..' style='width:60px;'/></td><td><input type='text' placeholder='Remarks..' style='width:60px;'/></td></tr>");
