...
<link rel="stylesheet" type="text/css"
	href="/ziksana-web/resources/css/dropdown.css" />
<link href="/ziksana-web/resources/css/styles.css" rel="stylesheet"
	type="text/css">
<link href="/ziksana-web/resources/css/type-setting.css"
	rel="stylesheet" type="text/css">
<link href="/ziksana-web/resources/css/effects.css" rel="stylesheet"
	type="text/css">
<link href="/ziksana-web/resources/css/nav.css" rel="stylesheet"
	type="text/css">
<link
	href="/ziksana-web/resources/css/common/wizard/wizardstylesheet.css"
	rel="stylesheet" type="text/css">
<link href="/ziksana-web/resources/css/spinner/smartspinner.css"
	rel="stylesheet" type="text/css">
<link rel="stylesheet"
	href="/ziksana-web/resources/css/chosen/superbly-tagfield.css" />
<link href="/ziksana-web/resources/css/assignment.css" rel="stylesheet"
	type="text/css">
<link rel='stylesheet' type='text/css'
	href="/ziksana-web/resources/css/nav.css" />
<!--End Body Style sheet-->

<script type="text/javascript"
	src="/ziksana-web/resources/js/jquery-1.7.1.min.js"></script>
...
<!-- css for tree -->
<link rel="stylesheet"
	href="/ziksana-web/resources/js/tree/styles/styleTree.css"
	type="text/css" />
...
<script type="text/javascript"
	src="/ziksana-web/resources/js/tree/jquery-1.8.0.min.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="/ziksana-web/resources/js/tree/myTreeEnrich.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="http://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxdata.js"></script>
<script type="text/javascript"
	src="http://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxbuttons.js"></script>
<script type="text/javascript"
	src="http://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxscrollbar.js"></script>
<script type="text/javascript"
	src="http://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxpanel.js"></script>
<script type="text/javascript"
	src="http://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/jqxtree.js"></script>

<!-- End tree -->
<link rel="stylesheet" type="text/css"
	href="/ziksana-web/resources/js/ui/jquery.fancybox-1.3.4.css"
	media="screen" />
<script type="text/javascript"
	src="/ziksana-web/resources/js/ui/jquery.mousewheel-3.0.4.pack.js"></script>
<script type="text/javascript"
	src="/ziksana-web/resources/js/ui/jquery.fancybox-1.3.4.pack.js"></script>
<script type='text/javascript'
	src="/ziksana-web/resources/js/custom/libraryfunction.js"></script>
<!-- scripts for number spinner -->
<script type="text/javascript"
	src="/ziksana-web/resources/js/chosen/superbly-tagfield.min.js"></script>
								...
								<div id="splitter" style='clear: both;'>
									...
									<div id='jqxWidget'>
										...
										<div id='jqxMenu' class="jqxMenu3">
											<ul>
												<li id="videocontainer2"><img
													src="/ziksana-web/resources/images/view.png" alt="View"
													height="10" width="10"
									...
									<div id="ContentPanel" style="font-size: 11px; margin: 1em;">
			...
			$('#jqx_course_tree')
					.bind(
							...
							function(event) {
								...
								var item = $('#jqx_course_tree').jqxTree(
										'getItem',
								...
								if (node_type == "LCONTENT") {
									...
									+ '/'
									+ content_id
									+ '" style="width:705px; height:600px;" scrolling="no"></iframe>_______________________________________________________________________________________________________________________________________________________________________________________________________________$tag____');
