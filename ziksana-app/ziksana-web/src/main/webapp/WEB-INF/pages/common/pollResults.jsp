...
<div class="zannouncementwrapper">
	...
	<div id="zAnnouncement">
        ...
        <div id="contentGroup">
            ...
            <input type="text" style="display:inline;width:100px; height:40px;" id="vDate" class="datepicker" title="Date Required" value="Value (Date)"/> 
            
                    <label value="Period"  style="display:inline;">End Date</label> 
                                  
             
			  <input type="text" style="display:inline;width:100px; height:40px;" id="EDate" class="datepicker" title="Date Required" value="Value (Date)"/> 
