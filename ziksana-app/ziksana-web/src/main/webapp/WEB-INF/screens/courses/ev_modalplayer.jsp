...
<script type="text/javascript"
	src="/ziksana-web/resources/js/jquery-1.7.2.min.js"></script>
...
<div id="video">
	...
	<script type="text/javascript">
		...
		swfobject.embedSWF("/ziksana-web/resources/jwplayer/EnhancePlayer.swf",
				"flashContent", "730px", "545px", swfVersionStr, xiSwfUrlStr,
				flashvars, params, attributes);
		// JavaScript enabled so display the flashContent div in case it is not replaced with a swf object.
		swfobject.createCSS("#flashContent", "display:block;text-align:left;");
		setTimeout('setUrl()', 4000);

		function ff_player_mode() {
			return "playback";
		}
		...
		function ff_get_recorded_file() {
			return "${ms.flashRecordingFolder}${content.contentUrl}";
		}
		function ff_get_flash_recorder() {
			return "${ms.flashRecordingScript}";
		};
	</script>
