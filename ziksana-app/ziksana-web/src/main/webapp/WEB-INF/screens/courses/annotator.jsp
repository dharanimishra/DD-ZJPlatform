...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"> 
  ...
  <!--       <link rel="stylesheet" type="text/css" href="history/history.css" />
        ...
        <script type="text/javascript">
            ...
            swfobject.embedSWF(
                "/ziksana-web/resources/swf/annotator.swf", "flashContent", 
                "100%", "100%", 
    ...
    <form action="">
        ...
        <noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="Application">
                <param name="movie" value="/ziksana-web/resources/swf/annotator.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="allowScriptAccess" value="sameDomain" />
                <param name="allowFullScreen" value="true" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="/ziksana-web/resources/swf/annotator.swf" width="100%" height="100%">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
