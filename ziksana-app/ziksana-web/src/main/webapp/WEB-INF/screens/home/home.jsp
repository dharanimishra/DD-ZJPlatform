...
<div id="contentpanel">
	...
	<div class="tilecontainer pull-left">
		...
		<c:if test="${member.roleType eq 'EDUCATOR'}">
			...
			<a href="/ziksana-web/zcourse/1/mycourse?draftCourse='DRAFTCOURSE'">
				<div class="tile bg-color-blueDark">
					...
					<div class="portlet-body">
						<div id="add_todo_fields_container"
							...
							<select id="todo_categories"
								...
								<input  maxlength="44"  style="height: 28px; width: 200px;"
								id="todo_category_name" />
							</span> <input maxlength="239" placeholder="Enter Your Description Here" onclick="clearTextBox()" id="todo_description"
