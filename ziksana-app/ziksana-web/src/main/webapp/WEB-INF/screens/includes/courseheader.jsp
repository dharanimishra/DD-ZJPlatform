...
<div id="leftpanel">
	...
	<div id="Headerborder">
		...
		<div id="HeaderNav" class="f-r">
			...
			<div id="ProfilePic" class="f-l">
				<img src="/ziksana-web/resources/images/home/profile.png"
					align="middle" class="Profile">
			</div>
			...
			<div id="AccountSetting" class="f-l">
				<span><img class="Profilepic"
					...
					class="Accounthead">Account Settings</span> <img class="Dropdown"
