...
public class MessageUtil implements MessageSourceAware
{
  ...
  {
    return messageSource.getMessage(messageCode, null, messageCode + " missing!!!", locale); 
  }
  
  
  public static final String getMessage(String messageCode, Object[] args, Locale locale)
  {
    return messageSource.getMessage(messageCode, args, messageCode + " missing!!!", locale);
  }
}
