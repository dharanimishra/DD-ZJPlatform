...
public class TagCloud extends AuditHistory {
	...
	private Integer creatingMemberID = null;
	...
	public Integer getCreatingMemberID() {
		return creatingMemberID;
	}

	public void setCreatingMemberID(Integer creatingMemberID) {
	...
	public String toString() {
		return "TagCloud [tagName=" + tagName + ", tagType=" + tagType
				...
				+ ", creatingMember=" + creatingMember + ", tagTypeId="
				+ tagTypeId + ", creatingMemberID=" + creatingMemberID + "]";
	}
