...
public class EnrichmentTest extends BaseTest {
	...
	public void testSaveReferenceOrTopicOrNotes() throws Exception{
		System.out.println("******** Inside testSaveReferenceOrTopicOrNotes *********");
	...
	private Enrichment constructEnrichment(Enrichment enrichment, LinkType linkType) {
		...
		contEnrichment.setEndTime(new Timestamp(System.currentTimeMillis()+10000));
