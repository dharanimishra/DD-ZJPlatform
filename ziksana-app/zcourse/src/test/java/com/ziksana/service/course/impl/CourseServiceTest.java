...
public class CourseServiceTest extends BaseTest {
	...
	public class CourseDefineTest extends BaseTest {
		...
		private Course buildCourseTreeData1() throws Exception {
			...
			compContent1
					.setCompContentType(ComponentContentType.COURSE_CONTENT);
			...
			compContent2
					.setLearrningComponentContentDetails(compContentDetails2);

			LearningComponentNest compNest2 = new LearningComponentNest(null,
					comp2);
			...
			LearningComponentNest compNest3 = new LearningComponentNest(null,
					comp3);
			 ...
			 * test2.setName("Test2");
			 * test2.setTestType(TestType.PRACTICE_TEST);
