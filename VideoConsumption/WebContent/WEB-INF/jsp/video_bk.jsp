...
({
    ...
    <div id="wrapper"> 
	 ...
	 <!--Header Container-->
      ...
      <!--slogen-->
      <div id="sub-nav" >
        <div class="f-l"><strong class="a-b"><a href="#">Course Name </a> </strong><strong class="a-b, light-blue">3. Survey </strong></div>
		...
		<div id="book-container"> 
				...
				<div id="book-chapter"> 
					<div id="book-index">
					 ...
					 <br/>
					 <p class="user-name-w1">3. SURVEY</p>

					 <ul>
							<li class="user-name-w2">3.1 Measurement and Modelling
								<ul class="user-name-w2" id="chapter" >
									<li><a href="#" onclick="displayVideo('video1.mp4','videos/');">3.1.1 Direct Methods</a></li>
									<li><a href="#" onclick="displayVideo('video2.mp4','videos/');">3.1.2 Remote Sensing</a></li>
									<li><a href="#" onclick="displayVideo('video3.mp4','videos/');">3.1.3 Modelling</a></li>
								</ul>
							</li><br/>
							<li class="user-name-w2" id="chapter">3.2 Scale
								<ul class="user-name-w2">
									<li><a href="#" onclick="displayVideo('video.mp4','videos/');">3.2.1 Measurement Scale</a></li>
									<li><a href="#" onclick="displayVideo('video1.mp4','videos/');">3.2.2 Micro-Scale Variation</a></li>
			
								</ul>
							</li><br/><br/>
									<li class="user-name-w2" >3.3 Energy Balance</li>
    ...
    <!-- START OF THE PLAYER EMBEDDING TO COPY-PASTE -->
	 ...
	 <script type="text/javascript">
		...
		function playerReady(obj) 
		{
			...
			player.setOverlay('overlay1', 'Hello World', 'l,t');
	  ...
	  jwplayer("videoSection").onTime(function() {
	 	  ...
	 	  jwplayer("videoSection").onPlay(function() {  
			 ...
			 for ( var i = 0; i < data.length; i++) {
				 ...
				 time = timeValue;
				 if(i == 0) {
					 link = '<a href="#" id=' +i +'  onclick="displayBookMark(\''+data[i].videoId+'\',\''+data[i].description+'\','+timeValue+' , \''+data[i].bookmarkTitle+'\');" style="margin-left: 2em;">'+data[i].bookmarkTitle+'</a><br/>';
				 } else {
					 link = link + '<a href="#" id=' +i +'  onclick="displayBookMark(\''+data[i].videoId+'\',\''+data[i].description+'\', '+timeValue+', \''+data[i].bookmarkTitle+'\');" style="margin-left: 2em;">'+data[i].bookmarkTitle+'</a><br/>';
				 }
			 };
			 if (link != null) {
	...
	<!-- END OF THE PLAYER EMBEDDING -->
							...
							<img type="button" src="images/mike.jpg" onclick=""/>
								...
								<div id="listen-text" >
									...
									<b>Notes:</b><br/>
									<div class="textArea"><form:textarea path="description" id="textArea" cols="45" rows="5" class="textArea" /></div>
		...
		<div id="section"> 
          ...
          <div id="col-lft" class="border-right">
            ...
            <div id="user-insight">
              ...
              <p class="document-icon"><a href="#" onclick="displayVideo('video1.mp4','videos/');">Video 1</a></p>
              <p class="document-icon"><a href="#" onclick="displayVideo('video2.mp4','videos/');">Video 2</a></p>
              <p class="document-icon"><a href="#" onclick="displayVideo('video3.mp4','videos/');">Video 3</a></p>			  
              <p class="txt-r" style="padding-right:20px;"> <a href="#" class="icon-cal">Calendar</a></p>
              <p class="titles-info">Reference Material</p>
              <p class="document-icon"><a href="#">Document1</a></p>
              <p class="document-icon"><a href="#">Document2</a></p>
              <p class="titles-info">Related Videos</p>
              <p class="video-icon"><a href="#">Video1.avi </a></p>
